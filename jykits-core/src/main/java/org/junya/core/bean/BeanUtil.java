...
import org.junya.core.bean.BeanDesc.PropDesc;
import org.junya.core.bean.copier.BeanCopier;
import org.junya.core.bean.copier.CopyOptions;
import org.junya.core.bean.copier.ValueProvider;
import org.junya.core.collection.CollUtil;
import org.junya.core.convert.Convert;
import org.junya.core.lang.Editor;
import org.junya.core.lang.Filter;
import org.junya.core.map.CaseInsensitiveMap;
import org.junya.core.map.MapUtil;
import org.junya.core.util.ArrayUtil;
import org.junya.core.util.ClassUtil;
...
public class BeanUtil {
	 ...
	 * 如果isSimple为{@code false}，则只匹配类名而忽略包名，例如：org.junya.TestEntity只匹配TestEntity<br>
	 * 如果isSimple为{@code true}，则匹配包括包名的全类名，例如：org.junya.TestEntity匹配org.junya.TestEntity
	 *
	 * @param bean          Bean
