...
import org.junya.core.exceptions.ValidateException;
...
public class Validator {
	...
	public static boolean isLetter(CharSequence value) {
		return StrUtil.isAllCharMatch(value, new org.junya.core.lang.Matcher<Character>() {
			@Override
