...
import com.junya.core.bean.BeanDesc.PropDesc;
import com.junya.core.bean.BeanPath;
import com.junya.core.bean.BeanUtil;
import com.junya.core.collection.CollectionUtil;
import com.junya.core.convert.Convert;
import com.junya.core.map.CaseInsensitiveLinkedMap;
import com.junya.core.map.CaseInsensitiveMap;
import com.junya.core.util.*;
import com.junya.http.json.serialize.GlobalSerializeMapping;
import com.junya.http.json.serialize.JSONObjectSerializer;
import com.junya.http.json.serialize.JSONSerializer;
...
public class JSONObject implements JSON, JSONGetter<String>, Map<String, Object> {
	...
	private void init(CharSequence source) {
		init(new JSONTokener(StringUtil.trim(source)));
	}
